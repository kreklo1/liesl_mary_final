...
renderPlot({
 ...
 ggplot()+
  geom_boxplot(data = summary_stats_data, 
               aes( x = .data[[input$x]]), y = summary_stats_data$borough, 
               color="deeppink") +
  labs(y = "Borough", x = "Price") 
...
Next time you are looking for a place to stay in New York City, consider splurging a bit on this beautiful AirBnb! There are 3 farmer's markets and several parks nearby, so lots to do and explore!
