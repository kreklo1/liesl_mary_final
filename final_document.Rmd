...
Airbnb with Other Variable Take 2
==========================

```{r}
ui <- fluidPage(
  tags$h2("Map with Airbnb Data and Parks"),
  tags$p("This map displays Airbnb data and other variables."),
  checkboxInput("overlay_parks", "Overlay Parks", FALSE),
  checkboxInput("overlay_rats", "Overlay Rats", FALSE),
  checkboxInput("overlay_markets", "Overlay Farmer's Markets", FALSE),
  leafletOutput("map")
)
